...
sim_data <- readRDS("analyses/simulations/C_60/sim_data.rds")
...
saveRDS(model, "analyses/simulations/C_60/commonk.rds")
#model_fit_results <- model_fit_results[-nrow(model_fit_results), ]
#model <- readRDS("analyses/simulations/C_60/commonk.rds")
...
model_fit_results <- rbind(model_fit_results, data.frame("Model" = "Normative",
                        ...
                        "WAIC"=model$posterior_samples$WAIC$WAIC,
                        "MSE"= model$cvvals$CVvalue,"SE"= model$cvvals$CVstandardError))
saveRDS(model, "analyses/simulations/C_60/normative.rds")
#model <- readRDS("analyses/simulations/C_60/normative.rds")
...
model_fit_results <- rbind(model_fit_results, data.frame("Model" = "VICS",
                        ...
                        "WAIC"=model$posterior_samples$WAIC$WAIC,
                        "MSE"= model$cvvals$CVvalue,"SE"= model$cvvals$CVstandardError))
saveRDS(model, "analyses/simulations/C_60/vics.rds")
#model <- readRDS("analyses/simulations/C_60/vics.rds")
...
model_fit_results <- rbind(model_fit_results, data.frame("Model" = "VII",
                        ...
                        "WAIC"=model$posterior_samples$WAIC$WAIC,
                        "MSE"= model$cvvals$CVvalue,"SE"= model$cvvals$CVstandardError))
saveRDS(model, "analyses/simulations/C_60/vii.rds")
#model <- readRDS("analyses/simulations/C_60/vii.rds")
...
model_fit_results <- rbind(model_fit_results, data.frame("Model" = "GoMRT",
                        ...
                        "WAIC"=model$posterior_samples$WAIC$WAIC,
                        "MSE"= model$cvvals$CVvalue,"SE"= model$cvvals$CVstandardError))
saveRDS(model, "analyses/simulations/C_60/gomrt.rds")
#model <- readRDS("analyses/simulations/C_60/gomrt.rds")
...
model_fit_results <- rbind(model_fit_results, data.frame("Model" = "DLCSL",
                        ...
                        "WAIC"=model$posterior_samples$WAIC$WAIC,
                        "MSE"= model$cvvals$CVvalue,"SE"= model$cvvals$CVstandardError))
saveRDS(model, "analyses/simulations/C_60/dlcsl.rds")
#model <- readRDS("analyses/simulations/C_60/dlcsl.rds")
...
model_fit_results <- rbind(model_fit_results, data.frame("Model" = "DLCTL",
                        ...
                        "WAIC"=model$posterior_samples$WAIC$WAIC,
                        "MSE"= model$cvvals$CVvalue,"SE"= model$cvvals$CVstandardError))
saveRDS(model, "analyses/simulations/C_60/dlctl.rds")
#model <- readRDS("analyses/simulations/C_60/dlctl.rds")
...
model_fit_results <- rbind(model_fit_results, data.frame("Model" = "MHM",
                        ...
                        "WAIC"=model$posterior_samples$WAIC$WAIC,
                        "MSE"= model$cvvals$CVvalue,"SE"= model$cvvals$CVstandardError))
saveRDS(model, "analyses/simulations/C_60/mhm.rds")
#model <- readRDS("analyses/simulations/C_60/mhm.rds")
...
model_fit_results <- rbind(model_fit_results, data.frame("Model" = "ILCRE",
                        ...
                        "WAIC"=model$posterior_samples$WAIC$WAIC,
                        "MSE"= model$cvvals$CVvalue,"SE"= model$cvvals$CVstandardError))
saveRDS(model, "analyses/simulations/C_60/ilcre.rds")
#model <- readRDS("analyses/simulations/C_60/ilcre.rds")
...
model_fit_results <- rbind(model_fit_results, data.frame("Model" = "ILCRI",
                        ...
                        "WAIC"=model$posterior_samples$WAIC$WAIC,
                        "MSE"= model$cvvals$CVvalue,"SE"= model$cvvals$CVstandardError))
saveRDS(model, "analyses/simulations/C_60/ilcri.rds")
#model <- readRDS("analyses/simulations/C_60/ilcri.rds")



saveRDS(model_fit_results,"analyses/simulations/C_60/model_fit_results.rds")
...
saveRDS(coverage_results,"analyses/simulations/C_60/coverage_results.rds")
library(tinytable)
...
model_fit_results <- rbind(model_fit_results, data.frame("Model" = "ILCRI",
                        ...
                        "Specificity" = cf$byClass['Specificity'],
                        "Precision" = cf$byClass['Precision']))
saveRDS(model_fit_results, "analyses/simulations/C_60/confusion_matrix.rds")
...
melted_mat <- melt(kappa_matrix)
  ...
  scale_fill_gradient(low="white", high="#C16622FF") + geom_text(aes(label = sprintf("%.2f",value)),  # Format to 2 decimal places
            ...
            labs(x="", y = "")
ggsave("60New680810kappa_agreement.pdf")
