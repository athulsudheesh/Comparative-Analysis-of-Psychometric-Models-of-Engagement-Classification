...
saveRDS(model, "analyses/simulations/C_10/commonk.rds")
#model_fit_results <- model_fit_results[-nrow(model_fit_results), ]
#model <- readRDS("analyses/simulations/C_10/commonk.rds")
...
model_fit_results <- rbind(model_fit_results, data.frame("Model" = "Normative",
                        ...
                        "WAIC"=model$posterior_samples$WAIC$WAIC,
                        "MSE"= model$cvvals$CVvalue,"SE"= model$cvvals$CVstandardError))
saveRDS(model, "analyses/simulations/C_10/normative.rds")
#model <- readRDS("analyses/simulations/C_10/normative.rds")
...
model_fit_results <- rbind(model_fit_results, data.frame("Model" = "VICS",
                        ...
                        "WAIC"=model$posterior_samples$WAIC$WAIC,
                        "MSE"= model$cvvals$CVvalue,"SE"= model$cvvals$CVstandardError))
saveRDS(model, "analyses/simulations/C_10/vics.rds")
#model <- readRDS("analyses/simulations/C_10/vics.rds")
...
model_fit_results <- rbind(model_fit_results, data.frame("Model" = "VII",
                        ...
                        "WAIC"=model$posterior_samples$WAIC$WAIC,
                        "MSE"= model$cvvals$CVvalue,"SE"= model$cvvals$CVstandardError))
saveRDS(model, "analyses/simulations/C_10/vii.rds")
#model <- readRDS("analyses/simulations/C_10/vii.rds")
...
model_fit_results <- rbind(model_fit_results, data.frame("Model" = "GoMRT",
                        ...
                        "WAIC"=model$posterior_samples$WAIC$WAIC,
                        "MSE"= model$cvvals$CVvalue,"SE"= model$cvvals$CVstandardError))
saveRDS(model, "analyses/simulations/C_10/gomrt.rds")
#model <- readRDS("analyses/simulations/C_10/gomrt.rds")
...
model_fit_results <- rbind(model_fit_results, data.frame("Model" = "DLCSL",
                        ...
                        "WAIC"=model$posterior_samples$WAIC$WAIC,
                        "MSE"= model$cvvals$CVvalue,"SE"= model$cvvals$CVstandardError))
saveRDS(model, "analyses/simulations/C_10/dlcsl.rds")
#model <- readRDS("analyses/simulations/C_10/dlcsl.rds")
...
model_fit_results <- rbind(model_fit_results, data.frame("Model" = "DLCTL",
                        ...
                        "WAIC"=model$posterior_samples$WAIC$WAIC,
                        "MSE"= model$cvvals$CVvalue,"SE"= model$cvvals$CVstandardError))
saveRDS(model, "analyses/simulations/C_10/dlctl.rds")
#model <- readRDS("analyses/simulations/C_10/dlctl.rds")
...
model_fit_results <- rbind(model_fit_results, data.frame("Model" = "MHM",
                        ...
                        "WAIC"=model$posterior_samples$WAIC$WAIC,
                        "MSE"= model$cvvals$CVvalue,"SE"= model$cvvals$CVstandardError))
saveRDS(model, "analyses/simulations/C_10/mhm.rds")
#model <- readRDS("analyses/simulations/C_10/mhm.rds")
...
model_fit_results <- rbind(model_fit_results, data.frame("Model" = "ILCRE",
                        ...
                        "WAIC"=model$posterior_samples$WAIC$WAIC,
                        "MSE"= model$cvvals$CVvalue,"SE"= model$cvvals$CVstandardError))
saveRDS(model, "analyses/simulations/C_10/ilcre.rds")
#model <- readRDS("analyses/simulations/C_10/ilcre.rds")
...
model_fit_results <- rbind(model_fit_results, data.frame("Model" = "ILCRI",
                        ...
                        "WAIC"=model$posterior_samples$WAIC$WAIC,
                        "MSE"= model$cvvals$CVvalue,"SE"= model$cvvals$CVstandardError))
saveRDS(model, "analyses/simulations/C_10/ilcri.rds")
#model <- readRDS("analyses/simulations/C_10/ilcri.rds")



saveRDS(model_fit_results,"analyses/simulations/C_10/model_fit_results.rds")
...
caption = "Model fit results from MCMC analysis for all models applied to C10 data") |>
...
saveRDS(rank_order, "C10rankorder.rds")
#===========================================================================
#                            MCMC Coverage Table 
#===========================================================================
...
saveRDS(coverage_results,"analyses/simulations/C_10/coverage_results.rds")
library(tinytable)
...
model_fit_results <- rbind(model_fit_results, data.frame("Model" = "ILCRI",
                        ...
                        "Specificity" = cf$byClass['Specificity'],
                        "Precision" = cf$byClass['Precision']))
saveRDS(model_fit_results, "analyses/simulations/C_10/confusion_matrix.rds")
numeric_cols <- names(model_fit_results)[names(model_fit_results) != "Model"]

# Multiply each numeric column by 100
model_fit_results[numeric_cols] <- model_fit_results[numeric_cols] * 100
rownames(model_fit_results) <-  NULL
